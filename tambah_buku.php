    ...
    <div class ="module form-module" style="margin-top: 70px">
      ...
      <div class="form">
        ...
        <form action="proses_tambah_buku.php" method="post" enctype="multipart/form-data">
            ...
            <input type ="text" rows="4" name="deskripsi" class="form-control" placeholder ="Deskripsi"></textarea>
             Foto Buku : 
            <input type="file" name="file" class="form-control"> <br>
            <input type="submit" style="background-color: #bebdb8" name="simpan" value="Tambah Buku" class="btn btn-primary">
      </div>
        </form>
